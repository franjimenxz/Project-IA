...
| Context compiler | `pytest tests/unit/agent/test_context_compiler.py -v` | AC-P09-009 (`tool_schemas`, `server=` descubierto) |
| Onboarding validator | `pytest tests/unit/onboarding/test_validator.py -v` | AC-P09-010 |
| Eval validator | `pytest tests/evals/unit/ -v` | AC-P09-010 |
