...
| P11-T02 | W10 | in_progress | P11-T01 | [brief](../phases/phase-11-agent-loop/agent-briefs/P11-T02-decision-contract.md) |
...
| P11-T02 | `ready → in_progress` | asignada a Implementador cloud | branch `implementation/P11-T02-decision-contract` |
| P11-T03–T04 | remain `blocked` | — | dependen de P11-T02; el contrato `LLMDecision` no se toca antes de aceptarla |
