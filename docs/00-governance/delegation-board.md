...
| P10-T01 | W9 | accepted | P09-T04 | [brief](../phases/phase-10-composition-root/agent-briefs/P10-T01-runtime-composition.md) |
| P11-T01 | W10 | accepted | P10-T01 | [brief](../phases/phase-11-agent-loop/agent-briefs/P11-T01-architecture-docs.md) |
| P11-T02 | W10 | accepted | P11-T01 | [brief](../phases/phase-11-agent-loop/agent-briefs/P11-T02-decision-contract.md) |
| P11-T03 | W10 | accepted | P11-T02 | [brief](../phases/phase-11-agent-loop/agent-briefs/P11-T03-harness-loop.md) |
| P11-T04 | W10 | accepted | P11-T03 | [brief](../phases/phase-11-agent-loop/agent-briefs/P11-T04-isolation-observability.md) |
| P12-T01 | W11 | accepted | Fase 11 accepted | [brief](../phases/phase-12-tenant-agent-profile/agent-briefs/P12-T01-architecture-docs.md) |
| P12-T02 | W11 | accepted | P12-T01 | [brief](../phases/phase-12-tenant-agent-profile/agent-briefs/P12-T02-profile-contract.md) |
| P13-T01 | W12 | accepted | Fase 12 accepted | [brief](../phases/phase-13-operator-html-lab/agent-briefs/P13-T01-instituciones-html.md) |
| P14-T01 | W13 | accepted | Fase 12 accepted; ADR-010 | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T01-gemini-adapter.md) |
| P14-T02 | W13 | accepted | Fase 12 accepted | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T02-lab-knowledge.md) |
| P14-T03 | W13 | accepted | Fase 12 accepted | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T03-faq-read-tools.md) |
| P14-T04 | W13 | accepted | P14-T01–T03 accepted | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T04-runtime-wiring.md) |
| P15-T01 | W14 | accepted | Fase 13 y 14 accepted | [brief](../phases/phase-15-lab-mcp-plugin/agent-briefs/P15-T01-architecture-docs.md) |
| P15-T02 | W14 | accepted | P15-T01 accepted | [brief](../phases/phase-15-lab-mcp-plugin/agent-briefs/P15-T02-lab-form-endpoint.md) |
| P15-T03 | W14 | accepted | P15-T02 accepted | [brief](../phases/phase-15-lab-mcp-plugin/agent-briefs/P15-T03-runtime-adapt.md) |

## Primer paso

P07-T01 accepted (PR #32). P07-T02 accepted (PR #40). P07-T03 accepted (PR #52). P07-T04 accepted (PR #55). Fase 7 T01–T04 accepted. P06-T01 accepted (PR #26). P06-T04 accepted (PR #29). P06-T02 accepted (PR #35). P06-T03 accepted (PR #37). P06-T05 accepted (PR #46). Fase 6 T01–T05 accepted. P08-T01 accepted (PR #28). P08-T02 accepted (PR #41). P08-T03 accepted (PR #47). P08-T04 accepted (PR #57). Fase 8 T01–T04 accepted. Residual no bloqueante P07-T02: `audit_event` sin `run_id`; nombres en texto libre quedan con owner de `redaction.py`. Residual P07-T04: catalog validator does not reject `run_id` on alert `signal.labels` (committed files do not use it). Residual P08-T02: `token=` not in `redact()`; service-layer disable trusts TenantAdminContext (enforcement in adapter); lock no longer solely load-bearing. Residual P06-T03: ReDoS quadratic `_KEY` en `redaction.py` (escalado; no FAIL de re-review). Residual P06-T05: EXT-007 SLO; unused spans `channel.receive`/`channel.send`/`tool.execute`; synthetic latencies. Residual P08-T03: preflight ports fail-closed until wired; `create_onboarding_router` montado en `create_app`; el servicio se construye en el composition root y `package_path` queda acotado a `IA_MCP_TENANT_PACKAGES_DIR` (fail-closed). La activación por HTTP sigue inalcanzable porque los preflight ports fallan cerrados. Residual P08-T04: preflight CLI still fail-closed on T03 defaults (secrets/MCP/eval) until real ports; E2E runbook test asserts no exit 2, not a full happy-path provision/activate; Core-gate exemption is only `src/ia_mcp/onboarding/cli.py` (intentional); `create_onboarding_router` ya montado (ver P08-T03). Append-only DB, allowlist prod y SAST CI siguen escalados. P05-T01–T04 siguen `blocked` por EXT. P09-T01 accepted (PR #59). P09-T02 accepted (PR #61). P09-T03 accepted (PR #63). Residual no bloqueante P09-T02: onboarding `enabled_tools ⊆ capabilities` sin test de reject; `TOOL_SKILL_PREFIX` solo mapea `appointments.`; `getattr` `enabled_tools` en appointments skill es defensivo. Residual no bloqueante P09-T03: live e2e with empty `allowed_tools` is a weak assertion; config integration `test_concurrent_publish_allocates_distinct_versions` flakes (pre-existing). P09-T04 accepted (PR #66). Fase 9 T01–T04 accepted. Residual no bloqueante P09-T04: no composition root in `src/` wires `SseMcpClient` into `ToolExecutor` (brief was protocol injection) — owner P10-T01. P08 core-diff `REGISTERED_BASE` resuelto: el guard afirmaba contra el working tree, por lo que vencía en cada fase nueva; ahora fija el rango histórico `dd810e0..11b3de5` (padre real del commit de onboarding; `9bbb790` pertenecía a la rama previa al rebase e incluye cambios legítimos de Core de P07) y conserva el escaneo del árbol vivo. Live e2e empty `allowed_tools` sigue siendo una aserción débil. El supuesto flake de `test_concurrent_publish_allocates_distinct_versions` **no era de test**: `_ensure_tenant` arbitraba `ON CONFLICT` sólo sobre `id` mientras `tenant` es único también en `slug`, de modo que una publicación concurrente fallaba con `UniqueViolation` en vez de ignorarse (medido: 21/400 = 5,25%). Corregido en `src/ia_mcp/configuration/adapters/sqlalchemy.py` (0/400 tras el arreglo); un slug de otro tenant ahora devuelve `ConfigurationError("slug_taken")` en lugar de diferirse a una violación de clave foránea. P10-T01 accepted (PR #68, `9380843`). Residual: AC-P10-003 sin test automatizado durable; `IA_MCP_MCP_ENDPOINTS` es dato de deployment (decisión coordinador); factory `TenantToolExecutors` (el harness no la consume); `channel_integration_ids` foto de startup; `tenant_tools={}`; `create_onboarding_router` montado. P11-T01 accepted (`310a553`); two-stage PASS; ADR-006 accepted. P11-T02 accepted (`3fbebfc`, PR #72); two-stage PASS. P11-T03 accepted (`d9fdde3`, PR #74); two-stage PASS. P11-T04 accepted (`c2d12a0`, PR #76); two-stage PASS. Fase 11 T01–T04 accepted. Stack de implementación en `main` vía PR #83 (`d2bd633`). Residual T03/T04: skill FAQ sin allowlist de lectura (loop inerte en production); sin campo de superficie en TenantConfig; tools del loop no aparecen en `RunInvestigation.tools` (sink durable, owner P07). P12-T01 accepted (`ef0decc`, PR #79); two-stage PASS; ADR-008 accepted. P12-T02 accepted (`632d02b`, PR #81); two-stage PASS. Fase 12 T01–T02 accepted. Residual T02: el loop de Fase 11 ya está en `main` (#83) y cada `generate` copia el mismo perfil; `FakeLLM` sigue ignorando el request. P13-T01 accepted (`a92d9af`, PR #91); two-stage PASS; Fase 13 T01 accepted. Fase 14 documentada (ADR-010, PR #87). P14-T01 accepted (`c9c23b5`, PR #93); two-stage PASS; `OUTPUT_CONTRACT` en parte de usuario aparte. P14-T02 accepted (`83a3f22`, PR #89); two-stage PASS. P14-T03 accepted (`47081d9`, PR #92); two-stage PASS; `registry.py` registra `FAQSkill` (desviación justificada). P14-T04 accepted (`1473e5f`, PR #97); two-stage PASS. Fase 14 T01–T04 accepted. Fase 15 documentada (ADR-011, PR #100). P15-T01 accepted. P15-T02 accepted (`87a21b9`, PR #102); two-stage PASS. P15-T03 accepted (`58dfcb5`, PR #105); two-stage PASS. Fase 15 T01–T03 accepted. Hotfix `30f1785` PR #107: `_draft_from_package` copia `enabled_tools` en el primer alta (antes defaultaba a `frozenset()` y el chat no veía el catálogo de `tools/list`). Instituciones provisionadas antes de ese commit siguen con tools vacías en Postgres hasta re-guardar el form. Residuales: [program-residuals.md](program-residuals.md). P05-T01–T04 siguen `blocked` por EXT.
...
| P10-T01 | `in_review → accepted` | `9380843` merged PR #68 | [P10-T01](../phases/phase-10-composition-root/evidence/P10-T01.md) |
| P11-T01 | `— → in_review` | `310a553` | ADR-006 y Fase 11; validadores documentales verdes. Pendiente de las dos revisiones |
| P11-T01 | `in_review → accepted` | `310a553` | [P11-T01](../phases/phase-11-agent-loop/evidence/P11-T01.md) two-stage PASS |
| P11-T02 | `blocked → ready` | dependencia P11-T01 aceptada | [P11-T01](../phases/phase-11-agent-loop/evidence/P11-T01.md) |
| P11-T02 | `ready → in_progress` | asignada a Implementador cloud | branch `cursor/p11-t02-decision-contract-9100` |
| P11-T02 | `in_progress → in_review → accepted` | `3fbebfc` PR #72 | [P11-T02](../phases/phase-11-agent-loop/evidence/P11-T02.md) two-stage PASS |
| P11-T03 | `blocked → ready` | dependencia P11-T02 aceptada | [P11-T02](../phases/phase-11-agent-loop/evidence/P11-T02.md) |
| P11-T03 | `ready → in_progress` | asignada a Implementador cloud | branch `cursor/p11-t03-harness-loop-25b5` |
| P11-T03 | `in_progress → in_review → accepted` | `d9fdde3` PR #74 | [P11-T03](../phases/phase-11-agent-loop/evidence/P11-T03.md) two-stage PASS |
| P11-T04 | `blocked → ready` | dependencia P11-T03 aceptada | [P11-T03](../phases/phase-11-agent-loop/evidence/P11-T03.md) |
| P11-T04 | `ready → in_progress` | asignada a Implementador cloud | branch `cursor/p11-t04-isolation-observability-8f76` |
| P11-T04 | `in_progress → in_review → accepted` | `c2d12a0` PR #76; land `d2bd633` PR #83 | [P11-T04](../phases/phase-11-agent-loop/evidence/P11-T04.md) two-stage PASS |
| P12-T01 | `— → ready → in_progress` | asignada a Implementador cloud (docs) | branch `cursor/p12-t01-architecture-docs-7207` |
| P12-T01 | `in_progress → in_review → accepted` | `ef0decc` PR #79 | [P12-T01](../phases/phase-12-tenant-agent-profile/evidence/P12-T01.md) two-stage PASS |
| P12-T02 | `blocked → ready → in_progress` | dependencia P12-T01 aceptada | branch `cursor/p12-t02-profile-contract-da94` |
| P12-T02 | `in_progress → in_review → accepted` | `632d02b` PR #81 | [P12-T02](../phases/phase-12-tenant-agent-profile/evidence/P12-T02.md) two-stage PASS |
| P13-T01 | `— → ready` | spec `#84`; ADR-009; Fase 13 documentada | [spec](../superpowers/specs/2026-08-31-operator-html-pages-design.md) |
| P13-T01 | `ready → in_progress` | asignada a Implementador cloud | [P13-T01](https://cursor.com/agents/bc-45c38cc8-708f-542e-94bb-3f7d1821ef5c) |
| P14-T01 | `— → ready` | ADR-010; Fase 14 documentada | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T01-gemini-adapter.md) |
| P14-T02 | `— → ready` | ADR-010; Fase 14 documentada | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T02-lab-knowledge.md) |
| P14-T03 | `— → ready` | ADR-010; Fase 14 documentada | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T03-faq-read-tools.md) |
| P14-T04 | `— → blocked` | espera T01–T03 accepted | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T04-runtime-wiring.md) |
| P14-T01 | `ready → in_progress` | asignada a Implementador cloud | [P14-T01](https://cursor.com/agents/bc-221973e1-33b4-5365-8c93-ef1417b2245d) |
| P14-T03 | `ready → in_progress` | asignada a Implementador cloud | [P14-T03](https://cursor.com/agents/bc-b67b97a4-40c0-5bb3-a6e8-b930c13f70ff) |
| P14-T02 | `ready → in_progress → in_review → accepted` | `83a3f22` PR #89 | [P14-T02](../phases/phase-14-runtime-bot/evidence/P14-T02.md) two-stage PASS |
| P13-T01 | `in_progress → in_review → accepted` | `a92d9af` PR #91 | [P13-T01](../phases/phase-13-operator-html-lab/evidence/P13-T01.md) two-stage PASS |
| P14-T03 | `in_progress → in_review → accepted` | `47081d9` PR #92 | [P14-T03](../phases/phase-14-runtime-bot/evidence/P14-T03.md) two-stage PASS |
| P14-T01 | `in_progress → in_review → accepted` | `c9c23b5` PR #93 | [P14-T01](../phases/phase-14-runtime-bot/evidence/P14-T01.md) two-stage PASS |
| P14-T04 | `blocked → ready` | T01–T03 accepted; `composition.py` libre | [brief](../phases/phase-14-runtime-bot/agent-briefs/P14-T04-runtime-wiring.md) |
| P14-T04 | `ready → in_progress` | asignada a Implementador cloud | [P14-T04](https://cursor.com/agents/bc-95e29507-abcc-511d-8ab6-fae5df73995f) |
| P14-T04 | `in_progress → in_review → accepted` | `1473e5f` PR #97 | [P14-T04](../phases/phase-14-runtime-bot/evidence/P14-T04.md) two-stage PASS |
| P15-T01 | `— → ready → accepted` | ADR-011; Fase 15 documentada | [P15-T01](../phases/phase-15-lab-mcp-plugin/evidence/P15-T01.md) |
| P15-T02 | `— → ready` | P15-T01 accepted | [brief](../phases/phase-15-lab-mcp-plugin/agent-briefs/P15-T02-lab-form-endpoint.md) |
| P15-T03 | `— → blocked` | espera T02 accepted | [brief](../phases/phase-15-lab-mcp-plugin/agent-briefs/P15-T03-runtime-adapt.md) |
| P15-T02 | `ready → in_progress` | asignada a Implementador cloud | `bc-58ff8d41-44ed-5fd9-991a-93a4d11fea35` |
| P15-T02 | `in_progress → in_review → accepted` | `87a21b9` PR #102 | [P15-T02](../phases/phase-15-lab-mcp-plugin/evidence/P15-T02.md) two-stage PASS |
| P15-T03 | `blocked → ready` | P15-T02 accepted | [brief](../phases/phase-15-lab-mcp-plugin/agent-briefs/P15-T03-runtime-adapt.md) |
| P15-T03 | `ready → in_progress` | asignada a Implementador cloud | `bc-7d98f8cd-098b-57f4-a213-9d57b4a243bf` |
| P15-T03 | `in_progress → in_review → accepted` | `58dfcb5` PR #105 | [P15-T03](../phases/phase-15-lab-mcp-plugin/evidence/P15-T03.md) two-stage PASS |
| hotfix | `main` | `30f1785` PR #107 | `_draft_from_package` conserva `enabled_tools` del package en el draft inicial |
