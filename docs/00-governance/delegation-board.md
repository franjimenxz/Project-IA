...
| P11-T03 | `ready → in_progress` | asignada a Implementador cloud | branch `implementation/P11-T03-harness-loop` |
| P11-T04 | remains `blocked` | — | depende de P11-T03; spans y suite de aislamiento no se tocan antes |
