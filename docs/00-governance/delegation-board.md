...
| P12-T01 | `— → ready → in_progress` | asignada a Implementador cloud (docs) | [P12-T01](../phases/phase-12-tenant-agent-profile/agent-briefs/P12-T01-architecture-docs.md) |
